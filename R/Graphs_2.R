...
low_mat <- matrix(low_mat, nrow = 15, ncol = 15)
low_mat <- cov2cor(low_mat)
colnames(low_mat) <- rownames(low_mat) <- c('No Tree', 'Oak', 'Elm', 'Hickory', 'Ash', 'Maple', 'Basswood', 'Walnut', 'Ironwood', 'Beech', 'Dogwood', 'Poplar/Tulip Poplar', 'Black Gum/Sweet Gum', 'Other Conifer', 'Other Hardwood')

upp_mat <- upper_sgibbs[ind]
upp_mat <- matrix(upp_mat, nrow = 15, ncol = 15)
