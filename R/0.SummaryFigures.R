...
xdata_uncond_ind2 <- sf::st_as_sf(xdata_uncond_ind, coords = c('long', 'lat'))
# Add current CRS
sf::st_crs(xdata_uncond_ind2) <- 'EPSG:3175'
# Convert to new CRS
xdata_uncond_ind2 <- sf::st_transform(xdata_uncond_ind2, crs = 'EPSG:4326')
...
slope <- xdata |>
  ...
  ggplot2::scale_color_gradient(low = 'lightgrey', high = 'black', 'Slope (°)', limits = c(0, 50)) +
  ggplot2::theme_void() +
  ggplot2::geom_sf(data = states, color = 'black', fill = NA, linewidth = 1) +
  ggplot2::coord_sf(crs = 'EPSG:4326') +
  ggplot2::theme(plot.title = element_text(size = 16, face = 'bold', hjust = 0.5),
...
swi <- xdata |>
  ...
  viridis::scale_color_viridis(option = 'viridis', direction = -1, stringr::str_wrap('SAGA Wetness Index\n', width = 10), limits = c(0, 15)) +
  ggplot2::theme_void() +
  ggplot2::geom_sf(data = states, color = 'black', fill = NA, linewidth = 1) +
  ggplot2::coord_sf(crs = 'EPSG:4326') +
  ggplot2::theme(plot.title = element_text(size = 16, face = 'bold', hjust = 0.5),
...
cla <- xdata |>
  ...
  viridis::scale_color_viridis(option = 'viridis', direction = -1, '% clay \n', limits = c(0, 100)) +
  ggplot2::theme_void() +
  ggplot2::geom_sf(data = states, color = 'black', fill = NA, linewidth = 1) +
  ggplot2::coord_sf(crs = 'EPSG:4326') +
  ggplot2::theme(plot.title = element_text(size = 16, face = 'bold', hjust = 0.5),
...
san <- xdata |>
  ...
  viridis::scale_color_viridis(option = 'viridis', direction = -1, '% sand \n', limits = c(0, 100)) +
  ggplot2::theme_void() +
  ggplot2::geom_sf(data = states, color = 'black', fill = NA, linewidth = 1) +
  ggplot2::coord_sf(crs = 'EPSG:4326') +
  ggplot2::theme(plot.title = element_text(size = 16, face = 'bold', hjust = 0.5),
...
AWC <- xdata |>
  ...
  viridis::scale_color_viridis(option = 'viridis', direction = -1, str_wrap('Available water content (cm/cm)', width = 14), limits = c(0, 80)) +
  ggplot2::theme_void() +
  ggplot2::geom_sf(data = states, color = 'black', fill = NA, linewidth = 1) +
  ggplot2::coord_sf(crs = 'EPSG:4326') +
  ggplot2::theme(plot.title = element_text(size = 16, face = 'bold', hjust = 0.5),
