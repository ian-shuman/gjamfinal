...
rm(list = ls())
#if(!require(parallel, lib.loc = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2')) install.packags('parallel', lib = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2', repos = 'http://cran.r-project.org', depenencies = T)
#if(!require(snow, lib.loc = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2')) install.packages('snow', lib = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2', repos = 'http://cran.r-project.org', dependencies = T)
#require(snow, lib.loc = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2')
#require(parallel, lib.loc = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2')
#require(snow, lib.loc = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2')
#require(parallel, lib.loc = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2')
require(crayon, lib.loc = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2')
require(withr, lib.loc = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2')
require(tzdb, lib.loc = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2')
require(backports, lib.loc = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2')
require(broom, lib.loc = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2')
require(tidyverse, lib.loc = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2')
require(gjam, lib.loc = '/afs/crc.nd.edu/user/h/hgallo/Rlibs2')
...
form1 = as.formula(~ mean.SlopeProjected + mean.AspectProjected + mean.CAC +
                     ...
                     Hydric + Floodplain + totalPPT + MeanTEMP + lat + long)
...
# Save
save.image(file = 'out/reduced_taxa-all_cov+latlong.RData')
