...
if(!require(snow, lib.loc = '/afs/crc.nd.edu/user/a/awillso2/Rlibs2')) install.packages('snow', lib = '/afs/crc.nd.edu/user/a/awillso2/Rlibs2', repos = 'http://cran.r-project.org', dependencies = T)
require(snow, lib.loc = '/afs/crc.nd.edu/user/a/awillso2/Rlibs2')
require(parallel, lib.loc = '/afs/crc.nd.edu/user/a/awillso2/Rlibs2')
require(snow, lib.loc = '/afs/crc.nd.edu/user/a/awillso2/Rlibs2')
require(parallel, lib.loc = '/afs/crc.nd.edu/user/a/awillso2/Rlibs2')
require(crayon, lib.loc = '/afs/crc.nd.edu/user/a/awillso2/Rlibs2')
require(withr, lib.loc = '/afs/crc.nd.edu/user/a/awillso2/Rlibs2')
require(tzdb, lib.loc = '/afs/crc.nd.edu/user/a/awillso2/Rlibs2')
require(backports, lib.loc = '/afs/crc.nd.edu/user/a/awillso2/Rlibs2')
require(broom, lib.loc = '/afs/crc.nd.edu/user/a/awillso2/Rlibs2')
require(tidyverse, lib.loc = '/afs/crc.nd.edu/user/a/awillso2/Rlibs2')
